...
*KCoreWG_BZ* loads the graph in compressed form in main memory. Because of the superb compression that WebGraph provide, we can fit in the main memory of a moderate machine with 12 GB RAM a large graph, such as Twitter 2010 with around 1.5 billion edges (for the dateset see http://law.di.unimi.it/webdata/twitter-2010/). 
